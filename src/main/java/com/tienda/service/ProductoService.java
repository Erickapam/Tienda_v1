...
public interface ProductoService {
    ...
    @Query(nativeQuery = true,
            value = "SELECT * FROM producto WHERE producto.precio BETWEEN :precioInf AND :precioSup ORDER BY id_categoria ASC, producto.precio DESC")
    public List<Producto> findByProductosByCategoriaAndPrecio(@Param("precioInf") double precioInf,
